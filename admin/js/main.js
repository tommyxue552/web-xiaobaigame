    ...
    async function renderDashboard(body) {
        ...
        try {
            ...
            body.innerHTML =
                ...
                "<div class=\"stat-card stat-published\"><div class=\"stat-icon\">&#x2705;</div><div class=\"stat-info\"><div class=\"stat-label\">已发布</div><div class=\"stat-value\">" + stats.published_games + "</div><div class=\"stat-sub\">发布率 " + publishRate + "%</div></div></div>" +
                ...
                "<div class=\"stat-card stat-category\"><div class=\"stat-icon\">&#x1F4C2;</div><div class=\"stat-info\"><div class=\"stat-label\">分类数量</div><div class=\"stat-value\">" + stats.category_count + "</div><div class=\"stat-sub\">游戏分类</div></div></div>" +
                "</div>" +
                "class=\"panel\">" +
